...
function playerLoaded(selector, time) {
  if(document.querySelector(selector)!=null) {
		var iframeDocument = document.querySelector(selector).contentDocument
		var myPlayer = iframeDocument.getElementById('sskyplayer')
		if(myPlayer != null){
			...
			setTimeout(function() {
				myPlayer.addEventListener('ctaShow', function(eventDetails) {
					...
					pageDataLayer.videoContent.videoCtaList
...
playerLoaded('.sunday-sky-video iframe', 500)
